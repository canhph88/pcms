...
$(function () {
    ...
    var bar_data = {
      ...
      color: '#926dde', borderWidth:'0.1'
    };

    var bar1_data = {
        label: 'test2',
        data : [['Jan', 20], ['Feb', 10], ['Mar', 15], ['Apr', 20], ['May', 11], ['Jun', 3], ['Jul', 18], ['Aug', 8], ['Sep', 15], ['Oct', 20], ['Nov', 11], ['Dec', 3]],
        color: 'red', borderWidth:'0.1'
    };



    // $.plot('#bar-chart', [bar_data, bar1_data], {
    //   grid  : {
    //     borderWidth: 1,
    //     borderColor: '#f3f3f3',
    //     tickColor  : '#f3f3f3'
    ...
    // var donutData = [
    //   { label: 'Jan-Apr', data: 45, color: '#f96868' },
    //   { label: 'May-Aug', data: 32, color: '#46be8a' },
    //   { label: 'Sep-Dec', data: 23, color: '#48b0f7' }
    // ]
