...
<ol class="breadcrumb">
    ...
    <li><span class="breadcrumb-item active">Create User</span></li>
</ol>

<h1 class="text-center helpr-title">Create User</h1>
<section>
    <div class="col-sm-12 col-md-6 col-md-offset-3">
        {!! Form::model($user, ['action' => 'UserController@store', 'method' => 'post', 'files' => 'true']) !!}
